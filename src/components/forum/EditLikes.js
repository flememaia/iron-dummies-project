...
class EditContribution extends React.Component {
  ...
  componentDidMount = async () => {
    try {
     // Atualizar o state com as informações da contribuição já salvas na API (o parâmetro de rota é o id da contribuição - diferente do id do user, que também foi armazenado na contribuição). 
